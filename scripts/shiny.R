    ...
    sidebarPanel(
      ...
      fluidRow(
        ...
        column(3, numericInput(
          "fixed_seed", "Seed:", value = 0, width = '60px'
        )),
        column(3, numericInput(
      ...
      fluidRow(
        ...
        column(3, numericInput(
          "Mult", "Scale DOWEs by:", value = 0, width = '60px'
        )),
      ...
      fluidRow(column(
        6, numericInput("fixed_amp", "Amplitude:", value = 1.5, width = '100px')
      ),
      column(
        6,
        tags$div(class = "slider-label", "φ:"),
      ...
      # Weekend effect
      fluidRow(column(
        6, numericInput("fixed_wee", "Weekend effect:", value = 0, width = '100px')
      ))
    ),
